...
- (BOOL)createAudioQueue
{
    ...
    switch (_audioCodecContext->codec_id) {
        ...
        case CODEC_ID_PCM_ALAW:
        {
            ...
            audioStreamBasicDesc_.mSampleRate = 8000;//_audioCodecContext->sample_rate;
            audioStreamBasicDesc_.mFormatFlags = kAudioFormatFlagIsPacked | kAudioFormatFlagIsSignedInteger;
            audioStreamBasicDesc_.mFramesPerPacket = 1;//_audioCodecContext->frame_size;
            audioStreamBasicDesc_.mChannelsPerFrame = 1;//_audioCodecContext->channels;
            audioStreamBasicDesc_.mBitsPerChannel = 8;
            audioStreamBasicDesc_.mBytesPerPacket = 1;
